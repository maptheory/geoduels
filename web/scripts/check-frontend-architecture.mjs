...
const geometryExceptions = new Map(Object.entries({
  ...
  "features/game/components/overlays/ResultDistanceBar.tsx": ["w-[140px]", "w-[170px]", "w-[280px]", "w-[340px]", "inset-[3px]", "border-[2.5px]", "pr-[30px]", "pl-[30px]"],
  ...
  "features/lobby/components/PartyPanel.tsx": ["max-w-[1180px]", "max-w-[900px]", "max-w-[1040px]", "grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]", "max-w-[600px]", "max-h-[34vh]", "max-h-[45vh]"],
